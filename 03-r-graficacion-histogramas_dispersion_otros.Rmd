...
df_lst_ndbi_ndvi.temp <- order(lst_ndvi_ndbi$lst_promedio, decreasing=FALSE)
# Nuevo data frame ordenado
df_lst_ndbi_ndvi.ordenado_lst <- lst_ndvi_ndbi[df_lst_ndbi_ndvi.temp,]
